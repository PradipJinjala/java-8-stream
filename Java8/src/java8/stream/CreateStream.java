...
public class CreateStream {
	...
	/**
	 * Gets the stream with match with find.
	 *
	 * @return the stream with match with find
	 */
	private static void getStreamWithMatchWithFind() {
		...
		emptList.stream().filter(e -> e.getAccount().matches("INDUS")).findAny().ifPresent(System.out::println);
	}
